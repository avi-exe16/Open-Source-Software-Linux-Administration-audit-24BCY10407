...
**Arguments:**
- `$1` — Path to the log file. Options: `/var/log/syslog` (Ubuntu), `/var/log/messages` (Fedora)
...
The script is fully interactive — it will prompt you for three answers. Your manifesto is saved to `manifesto_abhishek_shandilya.txt` in the current directory.
...
This repository and its scripts are submitted as academic coursework under the VITyarthi OSS NGMC programme. The scripts are original work by Abhishek Shandilya (24BCY10407).

VLC Media Player is licensed under [GNU GPL v2](https://www.gnu.org/licenses/old-licenses/gpl-2.0.html), with libVLC under [LGPL v2.1](https://www.gnu.org/licenses/old-licenses/lgpl-2.1.html). More information: [videolan.org](https://www.videolan.org/legal.html)
